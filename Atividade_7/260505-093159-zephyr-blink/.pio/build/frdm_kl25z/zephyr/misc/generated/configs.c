...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_MCUX_ADC16, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_MCUX_ADC16_CLK_DIV_RATIO_1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_MCUX_ADC16_VREF_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_MCUX, 1);
